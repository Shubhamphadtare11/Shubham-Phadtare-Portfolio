<?php
	...
	$response=array();
        ...
        // $to="hbhalerao.ecti@gmail.com";
        $to="shubhamphadtare6@gmail.com"; // Change to your email address
        ...
        $retval=true;
         ...
         if ($retval) {
               echo '<img src="maharaj.jpg" alt="" width="50"><p class="text-center">Mail Received: Thank you for your interest. We will get back to you soon...</p>';
         }
         else {
